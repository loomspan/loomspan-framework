...
function makeLargeChunkedPayloadArtifact(): Buffer {
  ...
  const records: Array<Record<string, unknown>> = [
    { ...common, sequence: 1, recordType: "TRACE_STARTED", metadata: { tracePath: "generated/large-chunked-payload.ndjson", consoleCompatibilityVersion: "1.0.0-beta.5", generationId: traceId }, data: { sessionId } },
