  ...
  targetApplication: async ({}, use) => {
    const server = http.createServer((request, response) => {
      ...
      if (path === "/_loomspan/observability/v1/instance") {
        ...
        response.end(
          '{"instanceId":"11111111-1111-4111-8111-111111111111","consoleCompatibilityVersion":"1.0.0-beta.2","observedAt":"2026-07-27T00:00:00Z","liveMonitoringAvailable":true,"registeredSkillCount":0,"activeExecutionCount":0,"catalogedTraceCount":0,"tracePersistencePolicy":"PERSISTENT","completionGraceTtl":"PT2M","traceCatalogMetadataTtl":"PT168H"}',
        );
        return;
      }
