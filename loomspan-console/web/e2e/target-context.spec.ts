...
const test = consoleTest.extend<{
  ...
  targetApplication: async ({}, use) => {
    ...
    const traceMetadata = JSON.stringify({ traceId, sessionId, generationId: traceId, entrySkill: "CheckDns", outcome: "SUCCEEDED", finalizedAt: "2026-07-24T12:00:00Z", sizeBytes: new TextEncoder().encode(artifactBody).byteLength, persistencePolicy: "ALWAYS", applicationTraceExpiresAt: "2026-08-03T00:00:00Z" });
