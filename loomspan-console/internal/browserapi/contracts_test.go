...
func TestBrowserTargetFixtureCorpusMatchesCommittedInventoryByteForByte(t *testing.T) {
	...
	base := fixtureBootstrap{ProcessID: "process-1", ConsoleVersion: "1.0.0-beta.3-SNAPSHOT", WorkspacePath: `C:\workspace`, TabID: "tab-1", CSRFToken: "csrf-1", TargetFormDefaults: map[string]string{"address": "", "applicationKey": ""}}
	noTarget := base
	...
	expected := map[string]any{
		...
		"error-incompatible.json": errorEnvelope{Error: browserError{
			...
			Details: consolecore.Details{ExpectedCompatibilityVersion: "1.0.0-beta.3-SNAPSHOT", ObservedCompatibilityVersion: "0.1.0"},
		}},
