...
func TestByteBudgetPaginationReconstructsFramesRecordsAndSearch(t *testing.T) {
	raw := strings.Join([]string{
		startedRecord(1),
		frameRecord(2, "one", "", false, "ROOT_MISSION", true),
		frameRecord(3, "two", "one", true, "MODEL_CALL", true),
		frameRecord(4, "two", "one", true, "MODEL_CALL", false),
		frameRecord(5, "three", "one", true, "MODEL_CALL", true),
		frameRecord(6, "three", "one", true, "MODEL_CALL", false),
		frameRecord(7, "four", "one", true, "MODEL_CALL", true),
		frameRecord(8, "four", "one", true, "MODEL_CALL", false),
		frameRecord(9, "one", "", false, "ROOT_MISSION", false),
