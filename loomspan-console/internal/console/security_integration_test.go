...
func TestLiveConsoleArtifactRoutesDoNotLeakPathsOrCredentials(t *testing.T) {
	...
	// small artifact body.
	artifactBody := []byte(`{"traceId":"trace-security","sessionId":"session-1","sequence":1,"timestamp":1784894400.000000000,"recordType":"TRACE_STARTED","frameId":null,"parentFrameId":null,"frameType":null,"route":null,"threadName":"th","metadata":{"consoleCompatibilityVersion":"development","generationId":"generation-test"},"data":null}` + "\n" +
	...
	traceMetadata := fmt.Sprintf(
		`{"targetScopeId":"scope-1","traceId":"trace-security","sessionId":"session-1","entrySkill":"CheckDns","generationId":"generation-test","outcome":"SUCCEEDED","finalizedAt":"2026-07-24T12:00:00Z","sizeBytes":%d,"persistencePolicy":"ALWAYS","applicationTraceExpiresAt":"2026-08-01T12:00:00Z"}`,
		len(artifactBody),
	)
