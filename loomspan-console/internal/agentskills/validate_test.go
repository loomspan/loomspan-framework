...
func TestRuntimeDebuggingSkillValidationRejectsUnsafeAndNonPortableVariants(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown metadata", replaceSkill("loomspan-version: \"1.0.0-beta.4\"", "another-version: \"1.0.0-beta.4\""), "metadata"},
		{"blank version metadata", replaceSkill("loomspan-version: \"1.0.0-beta.4\"", "loomspan-version: \"\""), "metadata"},
		{"unresolved version metadata", replaceSkill("loomspan-version: \"1.0.0-beta.4\"", "loomspan-version: \"${project.version}\""), "metadata"},
