...
func TestRuntimeDebuggingSkillValidationRejectsUnsafeAndNonPortableVariants(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown metadata", replaceSkill("loomspan-version: \"1.0.0-beta.3\"", "another-version: \"1.0.0-beta.3\""), "metadata"},
		{"blank version metadata", replaceSkill("loomspan-version: \"1.0.0-beta.3\"", "loomspan-version: \"\""), "metadata"},
		{"unresolved version metadata", replaceSkill("loomspan-version: \"1.0.0-beta.3\"", "loomspan-version: \"${project.version}\""), "metadata"},
