...
func TestRuntimeDebuggingSkillValidationRejectsUnsafeAndNonPortableVariants(t *testing.T) {
	tests := []struct {
		...
		{"unknown metadata", replaceSkill("loomspan-version: \"0.1.0-SNAPSHOT\"", "another-version: \"0.1.0-SNAPSHOT\""), "metadata"},
		{"blank version metadata", replaceSkill("loomspan-version: \"0.1.0-SNAPSHOT\"", "loomspan-version: \"\""), "metadata"},
		{"unresolved version metadata", replaceSkill("loomspan-version: \"0.1.0-SNAPSHOT\"", "loomspan-version: \"${project.version}\""), "metadata"},
