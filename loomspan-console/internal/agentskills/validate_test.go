...
func TestRuntimeDebuggingSkillValidationRejectsUnsafeAndNonPortableVariants(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown metadata", replaceSkill("loomspan-version: \"1.0.0-beta.4-SNAPSHOT\"", "another-version: \"1.0.0-beta.4-SNAPSHOT\""), "metadata"},
		{"blank version metadata", replaceSkill("loomspan-version: \"1.0.0-beta.4-SNAPSHOT\"", "loomspan-version: \"\""), "metadata"},
		{"unresolved version metadata", replaceSkill("loomspan-version: \"1.0.0-beta.4-SNAPSHOT\"", "loomspan-version: \"${project.version}\""), "metadata"},
