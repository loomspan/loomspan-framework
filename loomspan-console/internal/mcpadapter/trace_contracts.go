...
const (
	...
	QueryTracePlansToolName   = "LOOMSPAN_query_trace_plans"
...
type queryTracePlansInput struct {
	TraceID      string `json:"traceId"`
...
type frameDTO struct {
	...
	OpenedTimestampMillis   int64     `json:"openedTimestampMillis,omitempty"`
	...
	DirectAttemptCount      int       `json:"directAttemptCount,omitempty"`
	DirectRetryCount        int       `json:"directRetryCount,omitempty"`
	DirectValidationCount   int       `json:"directValidationCount,omitempty"`
	DirectFailureCount      int       `json:"directFailureCount,omitempty"`
