...
func (a *immutableRangeAnalysis) QueryPlans(_ context.Context, ref evidence.Reference, query traceanalysis.PlanQuery) (traceanalysis.Page[traceanalysis.PlanSummary], *consolecore.Error) {
