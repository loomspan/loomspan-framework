...
func (echoSummaryAnalysis) QueryPlans(_ context.Context, ref evidence.Reference, query traceanalysis.PlanQuery) (traceanalysis.Page[traceanalysis.PlanSummary], *consolecore.Error) {
	return traceanalysis.Page[traceanalysis.PlanSummary]{Context: traceanalysis.TraceContext{Evidence: ref, Handle: query.Handle}}, nil
}
...
func (analysis *leasingSummaryAnalysis) QueryPlans(_ context.Context, ref evidence.Reference, query traceanalysis.PlanQuery) (traceanalysis.Page[traceanalysis.PlanSummary], *consolecore.Error) {
	return traceanalysis.Page[traceanalysis.PlanSummary]{Context: traceanalysis.TraceContext{Evidence: ref, Handle: query.Handle}}, nil
}
