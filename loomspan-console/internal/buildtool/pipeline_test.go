...
func TestRunPipelineStopsWhenFrontendTestsFail(t *testing.T) {
	...
	err := runPipeline(modeVerify, pipelineContext{productVersion: "1.0.0-beta.4-SNAPSHOT"}, deps)
...
func TestRunPipelineExecutesRequiredOrder(t *testing.T) {
	...
	want := []phase{
		phaseToolchains, phaseNPMCI, phaseAgentSkill, phaseAgentEval, phaseFrontendTypecheck, phaseFrontendCoverage,
