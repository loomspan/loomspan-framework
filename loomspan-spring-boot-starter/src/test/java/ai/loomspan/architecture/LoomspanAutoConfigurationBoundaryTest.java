...
import ai.loomspan.autoconfigure.LoomspanObservabilityWebAutoConfiguration;
...
class LoomspanAutoConfigurationBoundaryTest
{
    ...
    {
        assertThat(AccessGuard.class.getPackageName()).startsWith("ai.loomspan.internal.");
        assertThat(SkillChatModelResolver.class.getPackageName()).startsWith("ai.loomspan.internal.");
    ...
    {
        noClasses().that().resideInAPackage("ai.loomspan.internal.core..")
                ...
                .check(new ClassFileImporter().withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
                        .importPackages("ai.loomspan.internal.core"));
    }
