...
| Model selection and connections | Focused, source-verified | Framework model aliases, named connections, drivers, thinking levels, candidate publication with credential references, migration, and diagnostics |
