...
- `YamlSkillCapabilityRegistrarTests` (`loomspan-spring-boot-starter/src/test/java/ai/loomspan/internal/skill/YamlSkillCapabilityRegistrarTests.java`) protects completed shared registration.
